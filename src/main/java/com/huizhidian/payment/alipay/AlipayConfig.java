...
public class AlipayConfig {
    ...
    // 合作身份者ID
    public static final String PARTNER = "2088121553139091";

    // 收款支付宝账号
    public static String SELLER_EMAIL = "837542559@qq.com";
    
    // 收款支付宝ID
    public static String SELLER_ID = PARTNER;

    // 商户的私钥
    public static String KEY = "iupcfdr0713qabbpuqrw5qngsxgxnrqc";
    ...
    // 合作伙伴名称
    public static final String SUBJECT = "红河州惠之店商贸有限公司";
