...
public class TdUser {
	...
	// 返现总数
	@Column
	private Double totalCashRewards;

	// 分销商冻结金额
	@Column
	private Double cashRewardsFrozen;

	// 返现给上级用户总数
	@Column
	private Double totalCashRewardsToUpuser;
	...
	public Double getTotalCashRewardsToUpuser() {
		return totalCashRewardsToUpuser;
	}

	public void setTotalCashRewardsToUpuser(Double totalCashRewardsToUpuser) {
	...
	public Double getTotalCashRewards() {
		return totalCashRewards;
	}

	public void setTotalCashRewards(Double totalCashRewards) {
	...
	public Double getCashRewardsFrozen() {
		return cashRewardsFrozen;
	}

	public void setCashRewardsFrozen(Double cashRewardsFrozen) {
