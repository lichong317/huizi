...
//    }
    ...
    public String setting(Integer page,
        ...
        couponPage = tdCouponService.findAllOrderBySortIdAsc(page, size);
    ...
    public String orderEdit(TdCoupon tdCoupon,
        ...
        if (null != tdCoupon.getTypeId())
        {
            ...
            if (null != cType)
            {
                tdCoupon.setTypeTitle(cType.getTitle());
                tdCoupon.setTypePicUri(cType.getPicUri());
                tdCoupon.setTypeDescription(cType.getDescription());
            }
        }
