...
">点击此订单账号,可查看此订单详情</span></h3>
    ...
    <div id="trans-status">
        <div class="notice-title status-failed" style="background: none;border: none;">
            <img class="notice-icon" title="付款失败" src="/client/img/transfailed.png"></img>
            <span class="notice-content" style="position: relative;"><#if order??>付款失败，或者支付结果验证失败，如果订单已经成功支付，请联系客服处理！<#else>找不到对应的订单！</#if></span>
        </div>
    </div>
