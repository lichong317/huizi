...
.Pother i{ display:block; width:100%; height:310px; padding:20px; background:url(/client/images/error_sorry.png) no-repeat center; margin-left:-20px;}
...
<section class="full404" data-minHeight="640">
    <article class="page404 mid">
        <p class="Ptitle">对不起，登录失败！</p>
        <a class="Pback" href="/login" title="">尝试重新登录</a>
        <p class="Pother">
            <i></i>
        </p>
