...
<table class="main">
  <tr>
    <td <#if !type??>class="sel"</#if> ><a href="/touch/promotion/tuan">正在进行</a></td>
    <td <#if type?? && type=="ongoing">class="sel"</#if> ><a href="/touch/promotion/tuan?type=ongoing">即将开始</a></td>
    <td <#if type?? && type=="passed">class="sel"</#if> ><a href="/touch/promotion/tuan?type=passed">往期回顾</a></td>   
  </tr>
</table>
</div>
...
{  
    ...
    return i;  
            ...
            <a class="phone_list" href="/touch/goods/${item.id?c!''}?qiang=3">
...
<section class="botmain">
  ...
  <p class="ta-c mb10">
    ...
    <span>&nbsp;|&nbsp;</span>
    <a class="fs09" href="/promotion/tuan">电脑版</a>
  </p>
