...
<input id="receiverName" type="text" class="text h07 lh7 fabg border w80 mga block ti1 mt40" placeholder="收货人姓名" />
<input id="mobile" type="text" class="text h07 lh7 fabg border w80 mga block ti1 mt20" placeholder="手机号码" />
<input id="postcode" type="text" class="text h07 lh7 fabg border w80 mga block ti1 mt20" placeholder="邮政编码" />
...
<textarea id="detailAdd" class="pt20 pb20 w80 mga h09 border block mt20 ti1 fabg" placeholder="详细地址" ></textarea>
