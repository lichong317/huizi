...
<#if address_list??>
    <#list address_list as item>
        <div class="addresslist">
             ...
             <a class="a2" href="/touch/user/address/delete?id=${item.id?c}&manage=1"><img src="/touch/images/member/del.png" /></a>
        </div>
    </#list>
</#if>

<div class="clear h05"></div>
<a class="redborbtn h06 lh6 w40 mga bor-rad" href="/touch/user/addressAdd?manage=1">添加新地址</a>
