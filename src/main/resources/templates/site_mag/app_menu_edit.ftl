...
<form method="post" action="/Verwalter/app/menu/save" id="form1">
<div>
<input type="hidden" name="__VIEWSTATE" id="__VIEWSTATE" value="${__VIEWSTATE!""}" >
<input type="hidden" name="id" value="<#if app_menu??>${app_menu.id?c}</#if>" >
</div>
<!--导航栏-->
<div class="location" style="position: static; top: 0px;">
  <a href="/Verwalter/app/menu/list"><i></i><span>返回列表页</span></a>
...
<div class="tab-content" style="display: block;">
    <dl>
        <dt>栏目名称</dt>
        <dd>
            <input name="title" type="text" value="<#if app_menu??>${app_menu.title!""}</#if>" class="input normal" datatype="*" sucmsg=" ">
...
<#--    <dl>
        <dt>跳转地址</dt>
        <dd>
            <input name="linkUri" type="text" value="<#if app_menu??>${app_menu.linkUri!"http://"}<#else>http://</#if>" class="input normal" datatype="*" sucmsg=" ">
    ...
    <dl>
        ...
        <dd>
            <div class="rule-multi-radio multi-radio">
                <span id="rblStatus">
                    <input type="radio" name="isEnable" value="1" <#if app_menu?? && app_menu.isEnable>checked="checked"</#if>>
                    <label>是</label>
                    <input type="radio" name="isEnable" value="0" <#if !app_menu?? || !app_menu.isEnable>checked="checked"</#if>>
                    <label>否</label>
                </span>
            </div>
        </dd>
    ...
    <dl>
        <dt>排序数字</dt>
        <dd>
            <input name="sortId" type="text" value="<#if app_menu??>${app_menu.sortId!""}<#else>99</#if>" class="input txt100" datatype="n" sucmsg=" ">
