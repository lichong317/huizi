...
<body class="mainbody">
<form name="form1" method="post" action="/Verwalter/prizecategory/list" id="form1">
<div>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" class="ltable">
  ...
  <tr class="odd_bg">
    <th width="8%">选择</th>
    <th align="left">奖项名称</th>
    <th align="left" width="17%">奖品类型</th>
    <#--><th align="left" width="17%">剩余数量</th> -->
    <th align="left" width="12%">排序</th>
    <th width="10%">操作</th>
  </tr>

    <#if prizeCategory_page??>
        <#list prizeCategory_page.content as item>
            <tr>
                <td align="center">
                ...
                <td><a href="/Verwalter/prizecategory/edit?id=${item.id?c}">${item.title!""}</a></td>
                <#if item.prizeType == 0>
                ...
                <td align="center">
                    <a href="/Verwalter/prizecategory/edit?id=${item.id?c}">修改</a>
                </td>
              </tr>
        </#list>
    </#if>
...
<!--内容底部-->
<#assign PAGE_DATA=prizeCategory_page />
