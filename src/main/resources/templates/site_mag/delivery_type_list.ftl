...
<body class="mainbody">
<form name="form1" method="post" action="/Verwalter/order/setting/delivery/list" id="form1">
<div>
...
<div class="toolbar-wrap">
  <div id="floatHead" class="toolbar">
    <div class="l-list">
      <ul class="icon-list">
        <li><a class="add" href="/Verwalter/order/setting/delivery/edit"><i></i><span>新增</span></a></li>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" class="ltable">
  ...
  <tr class="odd_bg">
    ...
    <#if delivery_type_page??>
        <#list delivery_type_page.content as item>
            <tr>
                <td align="center">
                ...
                <td><a href="/Verwalter/order/setting/delivery/edit?id=${item.id?c}">${item.title!""}</a></td>
                <td>${item.code!""}</td>
                <td><#if item.fee??>${item.fee?string("#.##")}</#if> 元</td>
                ...
                <td align="center">
                    <a href="/Verwalter/order/setting/delivery/edit?id=${item.id?c}">修改</a>
                </td>
              </tr>
        </#list>
    </#if>
...
<!--内容底部-->
<#assign PAGE_DATA=delivery_type_page />
