...
<form name="form1" method="post" action="/Verwalter/provider/list" id="form1">
<div>
...
<div class="toolbar-wrap">
  <div id="floatHead" class="toolbar" style="position: static; top: 42px;">
    <div class="l-list">
      <ul class="icon-list">
        <li><a class="add" href="/Verwalter/provider/edit"><i></i><span>新增</span></a></li>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" class="ltable">
  ...
  <tr class="odd_bg">
    ...
    <#if provider_page??>
        <#list provider_page.content as provider>
            <tr>
                <td align="center">
...
<!--内容底部-->
<#assign PAGE_DATA=provider_page />
