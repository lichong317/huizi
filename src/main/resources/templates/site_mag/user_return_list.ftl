...
<form name="form1" method="post" action="/Verwalter/user/return/list" id="form1">
<div>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" class="ltable">
  ...
  <tr class="odd_bg">
    ...
    <#if user_return_page??>
        <#list user_return_page.content as return>
            <tr>
                <td align="center">
                ...
                <td align="center"><#if return.isReturn?? && return.isReturn>退货<#else>换货</#if></td>
...
<!--内容底部-->
<#assign PAGE_DATA=user_return_page />
