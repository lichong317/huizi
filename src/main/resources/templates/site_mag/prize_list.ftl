...
<body class="mainbody">
<form name="form1" method="post" action="/Verwalter/prize/list" id="form1">
<div>
...
<!--导航栏-->
<div class="location">
  <a href="/Verwalter/prize/list" class="back"><i></i><span>返回列表页</span></a>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" class="ltable">
  ...
  <tr class="odd_bg">
    ...
    <th align="left">中奖用户</th>
    <th align="left" width="17%">奖品</th>
    <th align="left" width="17%">中奖日期</th> 
    <#--><th align="left" width="12%">排序</th>
    <th width="10%">操作</th>-->
  </tr>

    <#if prize_page??>
        <#list prize_page.content as item>
            <tr>
                <td align="center">
