...
<div class="tab-content">
  ...
  <dl>
    <dt>优惠券图片</dt>
    <dd>
        <input id="txtImgUrl" name="picUri" type="text" datatype="*" value="<#if coupon_type??>${coupon_type.picUri!""}</#if>" class="input normal upload-path">
  ...
  <dl>
    <dt>排序数字</dt>
    <dd>
      <input name="sortId" type="text" value="<#if coupon_type??>${coupon_type.sortId!""}<#else>99</#if>" class="input small" datatype="n" sucmsg=" ">
