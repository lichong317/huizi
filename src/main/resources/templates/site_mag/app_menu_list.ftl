...
<form name="form1" method="post" action="/Verwalter/app/menu/list" id="form1">
<div>
...
<div class="toolbar-wrap">
  <div id="floatHead" class="toolbar" style="position: static; top: 42px;">
    <div class="l-list">
      <ul class="icon-list">
        <li><a class="add" href="/Verwalter/app/menu/edit"><i></i><span>新增</span></a></li>
  ...
  <tr class="odd_bg">
    ...
    <#list app_menu_list!! as item>
        <tr>
            ...
            <td align="center"><a href="/Verwalter/app/menu/edit?id=${item.id?c}">${item.title!""}</a></td>
            ...
            <td align="center">
                <a href="/Verwalter/app/menu/edit?id=${item.id?c}">修改</a>
            </td>
        </tr>
    </#list>
