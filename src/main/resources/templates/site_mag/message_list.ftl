...
<form name="form1" method="post" action="/Verwalter/message/list" id="form1">
<div>
...
<div class="toolbar-wrap">
  <div id="floatHead" class="toolbar" style="position: static; top: 42px;">
    <div class="l-list">
      <ul class="icon-list">
        <li><a class="add" href="/Verwalter/message/edit"><i></i><span>新增</span></a></li>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" class="ltable">
  ...
  <tr class="odd_bg">
    <th width="5%">选择</th>
    <th align="left" width="15%">消息名称</th>
    <th align="center" width="5%">消息类别</th>
    ...
    <#if message_page??>
        <#list message_page.content as item>
            <tr>
                ...
                <td >
                    <a href="/Verwalter/message/edit?messageId=${item.id?c}">${item.title!""}</a>                    
                </td>
                <#if item.typeId?? && item.typeId == 0>
                    <td align="center">公告</td>
                <#elseif item.typeId?? && item.typeId == 1>
                ...
                <td align="center">
                    <a href="/Verwalter/message/edit?messageId=${item.id?c}">修改</a>
                </td>
            </tr>
        </#list>
    </#if>
