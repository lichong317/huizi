...
<script type="text/javascript">
    ...
    function showDialogChangePrice(goodsId) {
        $.dialog({
            ...
            min: false,
            title: "改价",
            content: 'url:/Verwalter/pointGoods/price?goodsId=' + goodsId,
            width: 600,
            height: 200
        });
    }
    ...
    function showDialogPriceLog(goodsId) {
        $.dialog({
            ...
            min: false,
            title: "改价记录",
            content: 'url:/Verwalter/pointGoods/price/log?goodsId=' + goodsId,
            width: 800,
            height: 500
        });
    }
...
<ul style="width: 1189px;">
    ...
    <li style="margin-right: 15.75px;">
        <div class="details <#if !content.coverImageUri??>nopic</#if>">
            ...
            <h1><span><a href="/Verwalter/pointGoods/edit?cid=${cid!""}&mid=${mid!""}&id=${content.id!""}&__VIEWSTATE=${__VIEWSTATE!""}">${content.title!""}</a></span></h1>
            ...
            <div class="foot">
              ...
              <a href="/Verwalter/pointGoods/edit?cid=${cid!""}&mid=${mid!""}&id=${content.id!""}&__VIEWSTATE=${__VIEWSTATE!""}" title="编辑" class="edit">编辑</a>
