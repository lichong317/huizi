...
<body class="mainbody">
<form name="form1" method="post" action="/Verwalter/redenvelopeType/list" id="form1">
<div>
...
<div class="toolbar-wrap">
  <div id="floatHead" class="toolbar">
    <div class="l-list">
      <ul class="icon-list">
        <li><a class="add" href="/Verwalter/redenvelopeType/edit"><i></i><span>新增</span></a></li>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" class="ltable">
  ...
  <tr class="odd_bg">
    ...
    <th align="left" width="17%">红包类型</th>
    <th align="left" width="17%">剩余数量</th> 
    <th align="left" width="12%">排序</th>
    <th width="10%">操作</th>
  </tr>

    <#if TdRedEnvelopeType_page??>
        <#list TdRedEnvelopeType_page.content as item>
            <tr>
                <td align="center">
                ...
                <td><a href="/Verwalter/redenvelopeType/edit?id=${item.id?c}">${item.title!""}</a></td>
...
<!--内容底部-->
<#assign PAGE_DATA=TdRedEnvelopeType_page />
